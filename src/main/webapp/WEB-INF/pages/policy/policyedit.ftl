        ...
        <div class="fly-panel fly-panel-user">
            <div class="layui-tab layui-tab-brief" lay-filter="user">
                <ul class="layui-tab-title" id="LAY_mine">
                    <li class="layui-this" lay-id="info">编辑政策</li>
                </ul>
                        ...
                        <form class="layui-form" method="post" action="${base}/policy/policyupdate">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="title" name="policy.title" value="${(policy.title)!}" autocomplete="off"
                            ...
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <div id="text"></div>
                                    <textarea id="content" name="policy.content" class="layui-textarea" lay-verify="content" style="display: none;">${(policy.content)!}</textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
