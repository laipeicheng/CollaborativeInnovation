        ...
        <div class="fly-panel fly-panel-user">
            <div class="layui-tab layui-tab-brief" lay-filter="user">
                <ul class="layui-tab-title" id="LAY_mine">
                    <li class="layui-this" lay-id="info">修改文章</li>
                </ul>
                <div class="layui-tab-content" style="padding: 20px 0;">
                    <div class="layui-form layui-form-pane layui-tab-item layui-show">
                        <form class="layui-form" method="post" action="${base}/article/articleupdate"
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" id="title" name="article.title" autocomplete="off"
                                           class="layui-input" lay-verify="title" value="${(article.title)!}"/>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select id="type" name="article.articletype.articletypeid">
                                        <#list articletypeList as articletype>
                                            <#if articletype.articletypeid=article.articletype.articletypeid>
                                                <option value="${(articletype.articletypeid)!}" selected>${(articletype.articletypename)!}</option>
                                            <#else>
                            ...
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <textarea id="summary" name="article.summary"
                                              class="layui-textarea" lay-verify="summary">${(article.summary)!}</textarea>
                                </div>
                            </div>
                            <div class="layui-form-item layui-form-text">
                                ...
                                <div class="layui-input-block">
                                    <div id="text"></div>
                                    <textarea id="content" name="article.content" class="layui-textarea" lay-verify="content" style="display: none;">${(article.content)!}</textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
